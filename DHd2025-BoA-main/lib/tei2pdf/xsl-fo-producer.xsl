...
<!-- Stagger the pages for print but not PDF -->
  ...
  <!-- <xsl:variable name="main_font">Noto Sans</xsl:variable> -->
  <!-- <xsl:variable name="main_font">Noto Serif</xsl:variable> -->
  <!-- <xsl:variable name="main_font">Cambria</xsl:variable> -->
  ...
  <xsl:template name="superscript">
    ...
    <xsl:attribute name="vertical-align">text-top</xsl:attribute>
  ...
  <xsl:template name="vorwort_text">
    <xsl:attribute name="font-family"><xsl:value-of select="$main_font"/></xsl:attribute>
  ...
  <xsl:template name="head">
    ...
    <xsl:choose>
      ...
      <xsl:when test="$output = 'pdf'">
        ...
        <xsl:attribute name="color">#09d69b</xsl:attribute><!-- DHd2024 Donau Blau -->
      </xsl:when>
    </xsl:choose>
    <xsl:attribute name="space-before">.2in</xsl:attribute>
    <xsl:attribute name="space-after">.2in</xsl:attribute>
...
<!-- Spezialfall: Bild in Tabelle -->
  ...
  <xsl:variable name="header_and_footer">
    <fo:static-content flow-name="before-even">
      ...
      <fo:block><xsl:call-template name="page_header"/>Digital Humanities im deutschsprachigen Raum 2025</fo:block>
    </fo:static-content>
  ...
  <xsl:template match="//term[text()='Vortrag: Offenes Feld']" mode="toc">
    <xsl:if test="(//term[text()='Vortrag: Offenes Feld'])[1] is ."><fo:block keep-with-next="always"><xsl:call-template name="subhead"/>Vorträge: Offenes Feld</fo:block></xsl:if>
  </xsl:template>
  
  <xsl:template match="//term[text()='Vortrag: Computergestützte Analyse oder Interpretation']" mode="toc">
    <xsl:if test="(//term[text()='Vortrag: Offenes Feld'])[1] is ."><fo:block keep-with-next="always"><xsl:call-template name="subhead"/>Vorträge: Computergestützte Analyse oder Interpretation</fo:block></xsl:if>
  </xsl:template>
  
  <xsl:template match="//term[text()='Vortrag: Methode']" mode="toc">
    <xsl:if test="(//term[text()='Vortrag: Offenes Feld'])[1] is ."><fo:block keep-with-next="always"><xsl:call-template name="subhead"/>Vorträge: Methode</fo:block></xsl:if>
  </xsl:template>
  
  <xsl:template match="//term[text()='Vortrag: Theorie, Metareflexion, Positionspapier']" mode="toc">
    <xsl:if test="(//term[text()='Vortrag: Offenes Feld'])[1] is ."><fo:block keep-with-next="always"><xsl:call-template name="subhead"/>Vorträge: Theorie, Metareflexion, Positionspapier</fo:block></xsl:if>
  </xsl:template>
  
  <xsl:template match="//term[text()='Vortrag: Tool oder Resource']" mode="toc">
    <xsl:if test="(//term[text()='Vortrag: Offenes Feld'])[1] is ."><fo:block keep-with-next="always"><xsl:call-template name="subhead"/>Vorträge: Tool oder Ressource</fo:block></xsl:if>
  </xsl:template>
      ...
      <xsl:if test="$output = 'pdf'">
        <fo:page-sequence master-reference="Full">
          <fo:flow flow-name="xsl-region-body">
            ...
            <fo:block>
              <fo:external-graphic src="/Users/patrickhelling/Documents/DHd2024-BoA-main/input/deckblatt/book-of-abstracts-frontmatter.pdf#page=1"
 ...
 <!--     <xsl:if test="$output = 'pdf'">
        <fo:page-sequence master-reference="Full">
          <fo:flow flow-name="xsl-region-body">
           <fo:flow flow-name="xsl-region-before"> 
              ...
              <xsl:attribute name="format">i</xsl:attribute>
            <fo:block>
              <fo:external-graphic src="/Users/patrickhelling/Documents/DHd2024-BoA-main/input/deckblatt/DHd2024_Logos_v8.pdf#page=1"
                                    content-width="scale-to-fit"
                                     content-height="scale-to-fit"
                                     scaling="uniform" />
            </fo:block>
      ...
      <xsl:if test="$output = 'pdf'">
        ...
        <!-- <fo:page-sequence master-reference="Full"> -->
          <!-- <fo:flow flow-name="xsl-region-before"> -->
            <fo:block>
              <fo:external-graphic src="/Users/patrickhelling/Documents/DHd2024-BoA-main/input/deckblatt/book-of-abstracts-impressum.pdf#page=1"
                                    content-width="scale-to-fit"
                                     content-height="scale-to-fit"
                                     scaling="uniform" />
            </fo:block> 
      ...
      <xsl:if test="$output = 'pdf'">
        <fo:page-sequence master-reference="Full">
          <fo:flow flow-name="xsl-region-body">
            ...
            <!-- <fo:flow flow-name="xsl-region-before"> -->
            <fo:block>
              <fo:external-graphic src="/Users/patrickhelling/Documents/DHd2024-BoA-main/input/deckblatt/book-of-abstracts-frontmatter-Sponsoren.pdf#page=1"
                content-width="scale-to-fit"
                content-height="scale-to-fit"
                scaling="uniform" />
            </fo:block> 
      ...
      <xsl:if test="$output = 'pdf'">
        <fo:page-sequence master-reference="Full">
          <fo:flow flow-name="xsl-region-body">
            <fo:block>
              <fo:external-graphic src="/Users/patrickhelling/Documents/DHd2024-BoA-main/input/deckblatt/book-of-abstracts-frontmatter-Vorwort.pdf"
                content-width="scale-to-fit"
                content-height="scale-to-fit"
                scaling="uniform" />
            </fo:block> 
      ...
      <xsl:if test="$output = 'pdf'">
        <fo:page-sequence master-reference="Full">
          <fo:flow flow-name="xsl-region-body">
            <fo:block>
              <fo:external-graphic src="/Users/patrickhelling/Documents/DHd2024-BoA-main/input/deckblatt/book-of-abstracts-frontmatter-Vorwort.pdf#page=2"
                content-width="scale-to-fit"
                content-height="scale-to-fit"
                scaling="uniform" />
            </fo:block> 
      ...
      <xsl:if test="$output = 'pdf'">
        <fo:page-sequence master-reference="Full">
          <fo:flow flow-name="xsl-region-body">
            ...
            <!-- <fo:flow flow-name="xsl-region-before"> -->
            <fo:block>
              <fo:external-graphic src="/Users/patrickhelling/Documents/DHd2024-BoA-main/input/deckblatt/book-of-abstracts-frontmatter-Reviewerinnen.pdf#page=1"
                content-width="scale-to-fit"
                content-height="scale-to-fit"
                scaling="uniform" />
            </fo:block> 
          ...
          <xsl:if test="normalize-space(teiHeader[1]/profileDesc[1]/textClass[1]/keywords[@n='category']/term[1]) = 'Intro'">
            ...
            <fo:page-sequence>
              <xsl:if test="@n='intro-001'">
                <xsl:attribute name="initial-page-number">i</xsl:attribute>
              </xsl:if>
              <xsl:choose>
                <xsl:when test="text/@n = 'single'">
                  <xsl:attribute name="master-reference">Single</xsl:attribute>
      ...
      <fo:page-sequence master-reference="Single">
        <fo:flow flow-name="xsl-region-body">
          ...
          <xsl:for-each select="//TEI">
            ...
            <xsl:if test="descendant::keywords[@n='subcategory']/term[1] = 'Keynote' or
              descendant::keywords[@n='subcategory']/term[1] = 'Panel' or
              descendant::keywords[@n='subcategory']/term[1] = 'Posterpräsentation' or
              descendant::keywords[@n='subcategory']/term[1] = 'Workshop' or
              descendant::keywords[@n='subcategory']/term[1] = 'Vortrag: Offenes Feld' or
              descendant::keywords[@n='subcategory']/term[1] = 'Vortrag: Computergestützte Analyse oder Interpretation' or
              descendant::keywords[@n='subcategory']/term[1] = 'Vortrag: Methode' or
              descendant::keywords[@n='subcategory']/term[1] = 'Vortrag: Theorie, Metareflexion, Positionspapier' or
              descendant::keywords[@n='subcategory']/term[1] = 'Vortrag: Tool oder Resource' or
              descendant::keywords[@n='subcategory']/term[1] = 'Doctoral Consortium'" >
 <!--             descendant::keywords[@n='subcategory']/term[1] = 'Reviewers'"> -->

              <xsl:choose>
 	        <xsl:when test="descendant::keywords[@n='subcategory']/term[1] = 'Panel'">
                  <!-- Panel does not have no authors, so gets a slightly different treatment -->
...
<!--      <xsl:if test="//keywords[@n='subcategory'][1]/term[1] = 'Reviewers'">
      ...
      <!--<xsl:if test="//keywords[@n='subcategory']/term[1] = 'Sektion'">
        ...
        <fo:page-sequence master-reference="Double">
          ...
          <fo:flow flow-name="xsl-region-body">
            <xsl:for-each select="//TEI">
              &lt;!&ndash; if paper. This is a lazy way to select the panels, but I wasn't too concerned with code efficiency. &ndash;&gt;
              <xsl:if test="normalize-space(teiHeader[1]/profileDesc[1]/textClass[1]/keywords[@n='subcategory']/term[1]) = 'Sektion'">
                &lt;!&ndash; Title &ndash;&gt;
                <fo:block id="{@n}" keep-with-next="always">
                  <xsl:call-template name="head"/>
                  <xsl:value-of select="teiHeader/fileDesc/titleStmt/title"/>
                  &lt;!&ndash; if variable is set, print ID's for proofing &ndash;&gt;
                  <xsl:if test="$id= 'yes'">
                    <xsl:text> - </xsl:text>
                    <xsl:value-of select="@n"/>
                  </xsl:if>
      ...
      <!-- ~~~~~~~~~~~~~~~~~~
      Vorträge: Offenes Feld
      ~~~~~~~~~~~~~~~~~~~~~ -->

      <!-- Title Page -->
      <xsl:if test="//keywords[@n='subcategory']/term[1] = 'Vortrag: Offenes Feld'">
        <fo:page-sequence master-reference="Single">
          <fo:flow flow-name="xsl-region-body">
            <fo:block>
              <xsl:call-template name="section_head"/>
              <xsl:text>Vorträge: Offenes Feld</xsl:text>
            </fo:block>
          </fo:flow>
        </fo:page-sequence>
        ...
        <fo:page-sequence master-reference="Double">
          ...
          <fo:flow flow-name="xsl-region-body">
            <xsl:for-each select="//TEI">
              ...
              <xsl:if test="normalize-space(teiHeader[1]/profileDesc[1]/textClass[1]/keywords[@n='subcategory']/term[1]) = 'Vortrag: Offenes Feld'">
                <!-- Title -->
                <fo:block id="{@n}" keep-with-next="always">
                  <xsl:call-template name="head"/>
                  <xsl:value-of select="teiHeader/fileDesc/titleStmt/title"/>
      ...
      <!-- ~~~~~~~~~~~~~~~~~~
      Vorträge: Computergestützte Analyse oder Interpretation
      ~~~~~~~~~~~~~~~~~~~~~ -->
      
      <!-- Title Page -->
      <xsl:if test="//keywords[@n='subcategory']/term[1] = 'Vortrag: Computergestützte Analyse oder Interpretation'">
        <fo:page-sequence master-reference="Single">
          <fo:flow flow-name="xsl-region-body">
            <fo:block>
              <xsl:call-template name="section_head"/>
              <xsl:text>Vortrag: Computergestützte Analyse oder Interpretation</xsl:text>
            </fo:block>
          </fo:flow>
        </fo:page-sequence>
        ...
        <fo:page-sequence master-reference="Double">
          ...
          <fo:flow flow-name="xsl-region-body">
            <xsl:for-each select="//TEI">
              <!-- if Vortrag. This is a lazy way to select the panels, but I wasn't too concerned with code efficiency. -->
              <xsl:if test="normalize-space(teiHeader[1]/profileDesc[1]/textClass[1]/keywords[@n='subcategory']/term[1]) = 'Vortrag: Computergestützte Analyse oder Interpretation'">
                <!-- Title -->
                <fo:block id="{@n}" keep-with-next="always">
                  <xsl:call-template name="head"/>
                  <xsl:value-of select="teiHeader/fileDesc/titleStmt/title"/>
      ...
      <!-- Title Page -->
      <xsl:if test="//keywords[@n='subcategory']/term[1] = 'Vortrag: Methode'">
        <fo:page-sequence master-reference="Single">
          <fo:flow flow-name="xsl-region-body">
            <fo:block>
              <xsl:call-template name="section_head"/>
              <xsl:text>Vortrag: Methode</xsl:text>
            </fo:block>
          </fo:flow>
        </fo:page-sequence>
        ...
        <fo:page-sequence master-reference="Double">
          ...
          <fo:flow flow-name="xsl-region-body">
            <xsl:for-each select="//TEI">
              <!-- if Vortrag. This is a lazy way to select the panels, but I wasn't too concerned with code efficiency. -->
              <xsl:if test="normalize-space(teiHeader[1]/profileDesc[1]/textClass[1]/keywords[@n='subcategory']/term[1]) = 'Vortrag: Methode'">
                <!-- Title -->
                <fo:block id="{@n}" keep-with-next="always">
                  <xsl:call-template name="head"/>
                  <xsl:value-of select="teiHeader/fileDesc/titleStmt/title"/>
      ...
      <!-- ~~~~~~~~~~~~~~~~~~
      Vorträge: Theorie, Metareflexion, Positionspapier
      ~~~~~~~~~~~~~~~~~~~~~ -->
      
      <!-- Title Page -->
      <xsl:if test="//keywords[@n='subcategory']/term[1] = 'Vortrag: Theorie, Metareflexion, Positionspapier'">
        <fo:page-sequence master-reference="Single">
          <fo:flow flow-name="xsl-region-body">
            <fo:block>
              <xsl:call-template name="section_head"/>
              <xsl:text>Vortrag: Theorie, Metareflexion, Positionspapier</xsl:text>
            </fo:block>
          </fo:flow>
        </fo:page-sequence>
        ...
        <fo:page-sequence master-reference="Double">
          ...
          <fo:flow flow-name="xsl-region-body">
            <xsl:for-each select="//TEI">
              <!-- if Vortrag. This is a lazy way to select the panels, but I wasn't too concerned with code efficiency. -->
              <xsl:if test="normalize-space(teiHeader[1]/profileDesc[1]/textClass[1]/keywords[@n='subcategory']/term[1]) = 'Vortrag: Theorie, Metareflexion, Positionspapier'">
                <!-- Title -->
                <fo:block id="{@n}" keep-with-next="always">
                  <xsl:call-template name="head"/>
                  <xsl:value-of select="teiHeader/fileDesc/titleStmt/title"/>
      ...
      <!-- ~~~~~~~~~~~~~~~~~~
      Vorträge: Tool oder Resource
      ~~~~~~~~~~~~~~~~~~~~~ -->
      
      <!-- Title Page -->
      <xsl:if test="//keywords[@n='subcategory']/term[1] = 'Vortrag: Tool oder Resource'">
        <fo:page-sequence master-reference="Single">
          <fo:flow flow-name="xsl-region-body">
            <fo:block>
              <xsl:call-template name="section_head"/>
              <xsl:text>Vortrag: Tool oder Resource</xsl:text>
            </fo:block>
          </fo:flow>
        </fo:page-sequence>
        ...
        <fo:page-sequence master-reference="Double">
          ...
          <fo:flow flow-name="xsl-region-body">
            <xsl:for-each select="//TEI">
              <!-- if Vortrag. This is a lazy way to select the panels, but I wasn't too concerned with code efficiency. -->
              <xsl:if test="normalize-space(teiHeader[1]/profileDesc[1]/textClass[1]/keywords[@n='subcategory']/term[1]) = 'Vortrag: Tool oder Resource'">
                <!-- Title -->
                <fo:block id="{@n}" keep-with-next="always">
                  <xsl:call-template name="head"/>
                  <xsl:value-of select="teiHeader/fileDesc/titleStmt/title"/>
      ...
      <!--<xsl:if test="$output = 'pdf'">
        <fo:page-sequence master-reference="Full">
          <fo:flow flow-name="xsl-region-body">
            <fo:block>
              <fo:external-graphic src="../../../input/images/Backcover.pdf" content-height="297mm" content-width="210mm"/>
            </fo:block>
          </fo:flow>
        </fo:page-sequence>
      </xsl:if> -->
...
<!--      <xsl:if test="$output = 'pdf'">
  ...
  <xsl:template match="figure">
    <xsl:choose>
      <xsl:when test="graphic/@n='intro'">
        <fo:block>
          ...
          <fo:external-graphic>
            ...
            <xsl:attribute name="src"><xsl:text>../../../input/deckblatt/</xsl:text><xsl:value-of select="graphic/@url"/></xsl:attribute>
            <xsl:call-template name="figure_intro"/>
          </fo:external-graphic>
        </fo:block>
      </xsl:when>

      <xsl:when test="graphic/@n='partner_logos'">
        <fo:block keep-together.within-page="always">
          <xsl:call-template name="partner_logo_container_intro"/>
          <fo:block text-align="center"><xsl:call-template name="logo_figure_head"/><xsl:apply-templates select="head"/></fo:block>
          <fo:external-graphic>
            <!-- <xsl:attribute name="src"><xsl:text>../../../input/images/</xsl:text><xsl:value-of select="graphic/@url"/></xsl:attribute> -->
            <xsl:attribute name="src"><xsl:text>../../../input/deckblatt/</xsl:text><xsl:value-of select="graphic/@url"/></xsl:attribute>
            <xsl:call-template name="partner_logo_intro"/>
          </fo:external-graphic>
        </fo:block>
      </xsl:when>

      <xsl:when test="graphic/@n='supporter_logos'">
        <fo:block keep-together.within-page="always">
          <xsl:call-template name="supporter_logo_container_intro"/>
          <fo:block text-align="center"><xsl:call-template name="logo_figure_head"/><xsl:apply-templates select="head"/></fo:block>
          <fo:external-graphic>
            <xsl:attribute name="src"><xsl:text>../../../input/images/</xsl:text><xsl:value-of select="graphic/@url"/></xsl:attribute>
            <xsl:call-template name="supporter_logo_intro"/>
          </fo:external-graphic>
        </fo:block>
      </xsl:when>
      ...
      <xsl:when test="graphic/@n='keynote'">
        <fo:block keep-together.within-page="always">
          <xsl:call-template name="figure_container_keynote"/>
          <fo:external-graphic>
            <xsl:attribute name="src"><xsl:text>../../../input/images/</xsl:text><xsl:value-of select="graphic/@url"/></xsl:attribute>
            <xsl:call-template name="figure_keynote"/>
          </fo:external-graphic>
          <fo:block text-align="center"><xsl:call-template name="figure_head"/><xsl:apply-templates select="head"/></fo:block>
        </fo:block>
      </xsl:when>
  ...
  <xsl:template match="code">
    <fo:block>
      <xsl:call-template name="code"/><xsl:apply-templates/></fo:block>
  </xsl:template>

  <!-- <xsl:template match="table"> -->
  <!--   <xsl:for-each select="head"> -->
  <!--     <fo:block> -->
  <!--         <xsl:call-template name="table_head"/><xsl:apply-templates select="."/></fo:block> -->
  <!--   </xsl:for-each> -->
  ...
  <!--<xsl:template match="seg[@n='ISBN']">
    <xsl:choose>
      <xsl:when test="$output = 'print'">
        <xsl:text>ISBN 978-3-00-062166-6</xsl:text>
      </xsl:when>
      <xsl:otherwise>
        <xsl:text>ISBN 978-3-00-062166-6</xsl:text>
      </xsl:otherwise>
