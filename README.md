...
the years. 
This code was taken from DHd2024 and modified.
...
You'll get a folder with the name "DHd-2025-BoA-Scripts". 

#### DHd2025-BoA-main contains all scripts for generating a Book of Abstracts. 
#### correction-footnotes contains a script for correcting footnotes.
#### add-ORCIDs contains a script for adding ORCID-IDs to the xml-files.
...
1c: File structure of DHd2025-BoA-main
--------------------
...
Change all file paths to local, e.g. "path/to/image/image001.jpg" should be simply "Pictures/image001.jpg"

#### Correction footnotes

* add xml-files to wrong_footnotes-folder
* open DHReConvalidator.py
** check xml_path which has to lead to the wrong_footnotes-folder
** check new_path which has to lead to the correct_footnotes-folder
* run DHReConvalidator.py
** python3 DHReConvalidator.py
** find the xml-files with correct footnotes in correct_footnotes-folder

#### add ORCIDs to xml-files

* Download file with authors information from ConfTool and add it to add-ORCIDs-folder
* authors file has to follow the schema of DHd2025_ORCIDs_example.csv
* add xml-files to add-ORCIDs-folder
* run insertORCIDs.tcl 
** tclsh insertORCIDs.tcl [path to xml_with_orcids-folder]
* find the xml-files with added ORCIDs in xml_with_orcids-folder
...
* line 375: replace "<xsl:attribute name="page-break-inside">avoid</xsl:attribute>" with "<xsl:attribute name="break-before">page</xsl:attribute>" so that every abstract starts on a new page
